  ...
  const navLinks = [
    { href: "/", label: "Home", type: "link" },
    {
      ...
      subLinks: [
        ...
        { href: "/products?id=spare_parts", label: "Auto Spare Parts" },
        ...
        <ul className="hidden md:flex items-center space-x-8">
              ...
              <li key={link.label}>
                {pathname === "/" ? (
                  <ScrollLink
                    ...
                    duration={500}
                    offset={-80}
                    className="cursor-pointer text-gray-600 hover:text-black transition-colors font-medium"
                  >
                    {link.label}
                  </ScrollLink>
                ) : (
          ...
          {pathname === "/" ? (
            <ScrollLink
              ...
              offset={-80}
            >
              <li className="bg-red-700 rounded-md py-2 px-4 cursor-pointer font-medium text-white hover:bg-red-800 transition-all">
                Enquiry
              </li>
            </ScrollLink>
          ) : (
        ...
        <div className="md:hidden flex font-medium items-center gap-4">
          ...
          {pathname === "/" ? (
            <ScrollLink
              ...
              offset={-80}
            >
              <div className="bg-red-700 rounded-md py-2 px-3 cursor-pointer font-medium text-white hover:bg-red-800 transition-all text-sm">
                Enquiry
              </div>
            </ScrollLink>
          ) : (
                ...
                link.type === "dropdown" ? (
                  <li key={link.label} className="w-full text-center">
                    <button
                      ...
                      className="w-full flex justify-center items-center font-semibold text-gray-800 text-lg py-2"
                    >
                      {link.label}
                      <ChevronDownIcon
                  ...
                  <li key={link.label}>
                    {pathname === "/" ? (
                      <ScrollLink
                        ...
                        offset={-80}
                        onClick={handleLinkClick}
                        className="cursor-pointer text-lg text-gray-700 hover:text-black py-2 block"
                      >
                        {link.label}
                      </ScrollLink>
                    ) : (
                  ...
                  <li key={link.label}>
                    <Link
                      href={link.href}
                      onClick={handleLinkClick}
                      className="text-lg text-gray-700 hover:text-black py-2 block"
                    >
                      {link.label}
                    </Link>
                  </li>
